...
export default function VerifyBVNPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // For BVN field, only allow numbers and limit to 11 digits
    if (name === "bvn") {
        ...
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8">
          ...
          <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
            ...
            <p className="text-foreground/70 text-xs">
              Verify your Bank Verification Number for secure banking operations
            </p>
          </div>
        </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-foreground/70 mt-2">
              {verificationStatus === "success"
                ...
                : "Confirm your identity using your Bank Verification Number"}
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition pr-10"
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <p className="text-foreground/70 text-sm mb-4">
                      Upload photos of your bank verification document
                    </p>
                    ...
                    <p className="text-xs text-foreground/50 mt-4">
                      Upload clear images of your bank verification document
                    </p>
                  </div>
                </div>
              )}
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <Lock className="w-5 h-5 mr-2" /> Verify BVN
                  </>
                )}
              </button>
            </form>
